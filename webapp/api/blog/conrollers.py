...
post_fields = {
    'id': fields.Integer(),
    'author': fields.String(attribute=lambda x: x.user.username),     #author    attribute=lambda x: x.user.username
    'title': fields.String(),
    'text': HTMLField(),
...
class PostApi(Resource):
    ...
    @jwt_required()            # forgotten jwyt_required "()" make a wrapper got an unexpected keyword "..."" error
